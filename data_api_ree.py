...
class DataAPIRee ():
    ...
    def __get_kwh_price(self, start_date: str, end_date: str,
            time_trunc="hour", geo="peninsula") -> list:
        ...
        kwh_prices_response = DataAPIRee.__parse_kwh_price_response(HTTPSRequest().get_request(url))
